...
class Skills extends React.Component {
  ...
  handleCheck = (e, type, checkbox) => {
    this.setState(prevState => {
      ...
      let place = { ...prevState.place };
      type === "experience"
        ? (experience[checkbox] = !experience[checkbox])
        : (place[checkbox] = !place[checkbox]);
  ...
  handleClick = action => {
    this.props.history.push(
      action === "next" ? "/lets-talk-react/portfolio" : "/lets-talk-react/info"
    );
  };
  ...
  validate = (discipline, experience, place) => {
    const errors = {
      ...
      experience: !Object.values(experience).every(field => !field)
        ? ""
        : "Please choose at least one",
      place: !Object.values(place).every(field => !field)
        ? ""
        : "Please choose at lease one"
    };
    return errors;
  };
  ...
  render() {
    const radio = [
      { id: "design", name: "discipline", label: "Design Research" },
      { id: "visual", name: "discipline", label: "Visual Design" },
      { id: "ux", name: "discipline", label: "UX Design" },
      { id: "front", name: "discipline", label: "Front-end Dev" }
    ];
    const experiences = [
      { id: "visual1", name: "experience", label: "Visual design" },
      { id: "ux1", name: "experience", label: "UX design" },
      { id: "front1", name: "experience", label: "Front-end Development" }
    ];
    const places = [
      { id: "texas", name: "place", label: "Austin, texas" },
      { id: "ca", name: "place", label: "New York, New York" },
      { id: "china", name: "place", label: "Shanghai, china" },
      { id: "ireland", name: "place", label: "Dublin, ireland" },
      { id: "uk", name: "place", label: "Hunley, United Kingdom" },
      { id: "germany", name: "place", label: "Boelingen, Germany" },
      { id: "else", name: "place", label: "Somewhere else" }
    ];
    ...
    return (
      <form onSubmit={this.handleSubmit}>
        ...
        {/* errors.discipline && touched.btnNext && <p> */}
        <br />
