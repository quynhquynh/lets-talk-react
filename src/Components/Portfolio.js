...
class Portfolio extends React.Component{
    ...
    validate = (portfolio) => {
        ...
        const errors = {
            portfolio: regexPortfolio.test(portfolio) ? '' : 'Please enter correct link'
        }
        return errors
    }
    ...
    render(){
        ...
        return(
            <form onSubmit={(e) => this.handleSubmit(e)}>
                <h4>Prove you're IBM's next great designer by sowing us wo you are. What you've done. How you think. Tell us your story.</h4>
                ...
                <input id="portfolio"
                    ...
                    onChange={e => this.handleChange(e, 'portfolio')} /><br/>

                <textarea id="else" style={{height: 200, width: '100%'}} name='else' onChange={e => this.handleChange(e, 'else')}placeholder="Anything else (another link, availability, etc.)?"></textarea>
                ...
                <input id="submit" type="submit" value="Submit" disabled={this.isSubmitDisabled(errors)} />
            </form>
        )
    }
}
